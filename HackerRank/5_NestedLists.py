...
# The lowest grade of belongs to
# Tina. The second lowest grade of belongs to both
# Harry andBerry, so we order their names alphabetically and print each name on a new line.
